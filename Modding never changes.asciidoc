...
. Download http://ui.darnified.net/wip/F3/dui_f3a11.zip[DUIF3 Alpha<sup>11</sup>]. The file is called `dui_f3a11.zip`.
. Download http://ui.darnified.net/wip/F3/dui_f3a11_HF.7z[DUIF3 Alpha<sup>11</sup> Hotfix]. The file is called `dui_f3a11_HF.7z`.
